...
KBGlowPrefs_FRAMEWORKS = UIKit CoreFoundation
...
after-stage::
	...
	@cp KBGlowPrefs/icon.png $(THEOS_STAGING_DIR)/Library/PreferenceBundles/KBGlowPrefs.bundle/icon.png
	@cp KBGlowPrefs/icon@2x.png $(THEOS_STAGING_DIR)/Library/PreferenceBundles/KBGlowPrefs.bundle/icon@2x.png
after-install::
