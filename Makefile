...
after-stage::
	...
	@if [ -f KBGlowPrefs/icon.png ]; then cp KBGlowPrefs/icon.png $(THEOS_STAGING_DIR)/Library/PreferenceBundles/KBGlowPrefs.bundle/icon.png; fi
	@if [ -f KBGlowPrefs/icon@2x.png ]; then cp KBGlowPrefs/icon@2x.png $(THEOS_STAGING_DIR)/Library/PreferenceBundles/KBGlowPrefs.bundle/icon@2x.png; fi
