...
- (void)setColor:(id)value specifier:(PSSpecifier*)s { if(![value boolValue])return; NSArray*x=[s propertyForKey:@"rgb"]; NSUserDefaults*d=[[NSUserDefaults alloc]initWithSuiteName:suite]; [d setObject:@[x[1],x[2],x[3]] forKey:@"colorRGB"]; CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(),note,NULL,NULL,true); [self reloadSpecifiers]; }
...
- (void)setValue:(id)v specifier:(PSSpecifier*)s { NSUserDefaults*d=[[NSUserDefaults alloc]initWithSuiteName:suite]; [d setObject:v forKey:[s propertyForKey:@"key"]]; }
- (void)applyCustom:(PSSpecifier*)s { NSUserDefaults*d=[[NSUserDefaults alloc]initWithSuiteName:suite]; CGFloat r=[d doubleForKey:@"customR"],g=[d doubleForKey:@"customG"],b=[d doubleForKey:@"customB"]; [d setObject:@[@(r),@(g),@(b)] forKey:@"colorRGB"]; CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(),note,NULL,NULL,true); }
@end
